...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function Ba(){return new Rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function ya(){return new Rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xs(),fragmentShader:`
	...
	`}function Su(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const A=a.mapping,c=A===is||A===rs,l=A===yn||A===si;if(c||l)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let u=e.get(a);return t===null&&(t=new va(i)),u=c?t.fromEquirectangular(a,u):t.fromCubemap(a,u),e.set(a,u),u.texture}else{if(e.has(a))return e.get(a).texture;{const u=a.image;if(c&&u&&u.height>0||l&&u&&r(u)){t===null&&(t=new va(i));const f=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,f),a.addEventListener("dispose",s),f.texture}else return null}}}return a}function r(a){let A=0;const c=6;for(let l=0;l<c;l++)a[l]!==void 0&&A++;return A===c}function s(a){const A=a.target;A.removeEventListener("dispose",s);const c=e.get(A);c!==void 0&&(e.delete(A),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function vu(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Mu(i,e,t,n){const r={},s=new WeakMap;function o(u){const f=u.target;f.index!==null&&e.remove(f.index);for(const m in f.attributes)e.remove(f.attributes[m]);for(const m in f.morphAttributes){const g=f.morphAttributes[m];for(let d=0,h=g.length;d<h;d++)e.remove(g[d])}f.removeEventListener("dispose",o),delete r[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(u,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,t.memory.geometries++),f}function A(u){const f=u.attributes;for(const m in f)e.update(f[m],i.ARRAY_BUFFER);const p=u.morphAttributes;for(const m in p){const g=p[m];for(let d=0,h=g.length;d<h;d++)e.update(g[d],i.ARRAY_BUFFER)}}function c(u){const f=[],p=u.index,m=u.attributes.position;let g=0;if(p!==null){const S=p.array;g=p.version;for(let C=0,B=S.length;C<B;C+=3){const b=S[C+0],T=S[C+1],y=S[C+2];f.push(b,T,T,y,y,b)}}else if(m!==void 0){const S=m.array;g=m.version;for(let C=0,B=S.length/3-1;C<B;C+=3){const b=C+0,T=C+1,y=C+2;f.push(b,T,T,y,y,b)}}else return;const d=new(Ao(f)?Eo:mo)(f,1);d.version=g;const h=s.get(u);h&&e.remove(h),s.set(u,d)}function l(u){const f=s.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:A,getWireframeAttribute:l}}function Bu(i,e,t,n){const r=n.isWebGL2;let s;function o(p){s=p}let a,A;function c(p){a=p.type,A=p.bytesPerElement}function l(p,m){i.drawElements(s,m,a,p*A),t.update(m,s,1)}function u(p,m,g){if(g===0)return;let d,h;if(r)d=i,h="drawElementsInstanced";else if(d=e.get("ANGLE_instanced_arrays"),h="drawElementsInstancedANGLE",d===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}d[h](s,m,a,p*A,g),t.update(m,s,g)}function f(p,m,g){if(g===0)return;const d=e.get("WEBGL_multi_draw");if(d===null)for(let h=0;h<g;h++)this.render(p[h]/A,m[h]);else{d.multiDrawElementsWEBGL(s,m,0,a,p,0,g);let h=0;for(let S=0;S<g;S++)h+=m[S];t.update(h,s,1)}}this.setMode=o,this.setIndex=c,this.render=l,this.renderInstances=u,this.renderMultiDraw=f}function yu(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Tu(i,e){return i[0]-e[0]}function wu(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Ru(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new dt,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function A(c,l,u){const f=c.morphTargetInfluences;if(e.isWebGL2===!0){const m=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,g=m!==void 0?m.length:0;let d=s.get(l);if(d===void 0||d.count!==g){let Q=function(){ne.dispose(),s.delete(l),l.removeEventListener("dispose",Q)};var p=Q;d!==void 0&&d.texture.dispose();const C=l.morphAttributes.position!==void 0,B=l.morphAttributes.normal!==void 0,b=l.morphAttributes.color!==void 0,T=l.morphAttributes.position||[],y=l.morphAttributes.normal||[],Y=l.morphAttributes.color||[];let I=0;C===!0&&(I=1),B===!0&&(I=2),b===!0&&(I=3);let v=l.attributes.position.count*I,k=1;v>e.maxTextureSize&&(k=Math.ceil(v/e.maxTextureSize),v=e.maxTextureSize);const W=new Float32Array(v*k*4*g),ne=new ho(W,v,k,g);ne.type=Ut,ne.needsUpdate=!0;const R=I*4;for(let G=0;G<g;G++){const V=T[G],z=y[G],X=Y[G],q=v*k*4*G;for(let te=0;te<V.count;te++){const se=te*R;C===!0&&(o.fromBufferAttribute(V,te),W[q+se+0]=o.x,W[q+se+1]=o.y,W[q+se+2]=o.z,W[q+se+3]=0),B===!0&&(o.fromBufferAttribute(z,te),W[q+se+4]=o.x,W[q+se+5]=o.y,W[q+se+6]=o.z,W[q+se+7]=0),b===!0&&(o.fromBufferAttribute(X,te),W[q+se+8]=o.x,W[q+se+9]=o.y,W[q+se+10]=o.z,W[q+se+11]=X.itemSize===4?o.w:1)}}d={count:g,texture:ne,size:new Oe(v,k)},s.set(l,d),l.addEventListener("dispose",Q)}let h=0;for(let C=0;C<f.length;C++)h+=f[C];const S=l.morphTargetsRelative?1:1-h;u.getUniforms().setValue(i,"morphTargetBaseInfluence",S),u.getUniforms().setValue(i,"morphTargetInfluences",f),u.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),u.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}else{const m=f===void 0?0:f.length;let g=n[l.id];if(g===void 0||g.length!==m){g=[];for(let B=0;B<m;B++)g[B]=[B,0];n[l.id]=g}for(let B=0;B<m;B++){const b=g[B];b[0]=B,b[1]=f[B]}g.sort(wu);for(let B=0;B<8;B++)B<m&&g[B][1]?(a[B][0]=g[B][0],a[B][1]=g[B][1]):(a[B][0]=Number.MAX_SAFE_INTEGER,a[B][1]=0);a.sort(Tu);const d=l.morphAttributes.position,h=l.morphAttributes.normal;let S=0;for(let B=0;B<8;B++){const b=a[B],T=b[0],y=b[1];T!==Number.MAX_SAFE_INTEGER&&y?(d&&l.getAttribute("morphTarget"+B)!==d[T]&&l.setAttribute("morphTarget"+B,d[T]),h&&l.getAttribute("morphNormal"+B)!==h[T]&&l.setAttribute("morphNormal"+B,h[T]),r[B]=y,S+=y):(d&&l.hasAttribute("morphTarget"+B)===!0&&l.deleteAttribute("morphTarget"+B),h&&l.hasAttribute("morphNormal"+B)===!0&&l.deleteAttribute("morphNormal"+B),r[B]=0)}const C=l.morphTargetsRelative?1:1-S;u.getUniforms().setValue(i,"morphTargetBaseInfluence",C),u.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:A}}function bu(i,e,t,n){let r=new WeakMap;function s(A){const c=n.render.frame,l=A.geometry,u=e.get(A,l);if(r.get(u)!==c&&(e.update(u),r.set(u,c)),A.isInstancedMesh&&(A.hasEventListener("dispose",a)===!1&&A.addEventListener("dispose",a),r.get(A)!==c&&(t.update(A.instanceMatrix,i.ARRAY_BUFFER),A.instanceColor!==null&&t.update(A.instanceColor,i.ARRAY_BUFFER),r.set(A,c))),A.isSkinnedMesh){const f=A.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return u}function o(){r=new WeakMap}function a(A){const c=A.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class vo extends xt{constructor(e,t,n,r,s,o,a,A,c,l){if(l=l!==void 0?l:vn,l!==vn&&l!==oi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&l===vn&&(n=ln),n===void 0&&l===oi&&(n=Sn),super(null,r,s,o,a,A,l,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:ht,this.minFilter=A!==void 0?A:ht,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Mo=new xt,Bo=new vo(1,1);Bo.compareFunction=oo;const yo=new ho,To=new uo,wo=new Io,Ta=[],wa=[],Ra=new Float32Array(16),ba=new Float32Array(9),Da=new Float32Array(4);function li(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Ta[r];if(s===void 0&&(s=new Float32Array(r),Ta[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function st(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function at(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function dr(i,e){let t=wa[e];t===void 0&&(t=new Int32Array(e),wa[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Du(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Lu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2fv(this.addr,e),at(t,e)}}function Uu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(st(t,e))return;i.uniform3fv(this.addr,e),at(t,e)}}function Qu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4fv(this.addr,e),at(t,e)}}function Pu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),at(t,e)}else{if(st(t,n))return;Da.set(n),i.uniformMatrix2fv(this.addr,!1,Da),at(t,n)}}function Fu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),at(t,e)}else{if(st(t,n))return;ba.set(n),i.uniformMatrix3fv(this.addr,!1,ba),at(t,n)}}function Nu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),at(t,e)}else{if(st(t,n))return;Ra.set(n),i.uniformMatrix4fv(this.addr,!1,Ra),at(t,n)}}function Ou(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Gu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2iv(this.addr,e),at(t,e)}}function Hu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;i.uniform3iv(this.addr,e),at(t,e)}}function ku(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4iv(this.addr,e),at(t,e)}}function zu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Vu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2uiv(this.addr,e),at(t,e)}}function Wu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;i.uniform3uiv(this.addr,e),at(t,e)}}function qu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4uiv(this.addr,e),at(t,e)}}function Xu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Bo:Mo;t.setTexture2D(e||s,r)}function Yu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||To,r)}function Ju(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||wo,r)}function Ku(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||yo,r)}function ju(i){switch(i){case 5126:return Du;case 35664:return Lu;case 35665:return Uu;case 35666:return Qu;case 35674:return Pu;case 35675:return Fu;case 35676:return Nu;case 5124:case 35670:return Ou;case 35667:case 35671:return Gu;case 35668:case 35672:return Hu;case 35669:case 35673:return ku;case 5125:return zu;case 36294:return Vu;case 36295:return Wu;case 36296:return qu;case 35678:case 36198:case 36298:case 36306:case 35682:return Xu;case 35679:case 36299:case 36307:return Yu;case 35680:case 36300:case 36308:case 36293:return Ju;case 36289:case 36303:case 36311:case 36292:return Ku}}function Zu(i,e){i.uniform1fv(this.addr,e)}function $u(i,e){const t=li(e,this.size,2);i.uniform2fv(this.addr,t)}function ed(i,e){const t=li(e,this.size,3);i.uniform3fv(this.addr,t)}function td(i,e){const t=li(e,this.size,4);i.uniform4fv(this.addr,t)}function nd(i,e){const t=li(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function id(i,e){const t=li(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function rd(i,e){const t=li(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function sd(i,e){i.uniform1iv(this.addr,e)}function ad(i,e){i.uniform2iv(this.addr,e)}function od(i,e){i.uniform3iv(this.addr,e)}function Ad(i,e){i.uniform4iv(this.addr,e)}function cd(i,e){i.uniform1uiv(this.addr,e)}function ld(i,e){i.uniform2uiv(this.addr,e)}function hd(i,e){i.uniform3uiv(this.addr,e)}function ud(i,e){i.uniform4uiv(this.addr,e)}function dd(i,e,t){const n=this.cache,r=e.length,s=dr(t,r);st(n,s)||(i.uniform1iv(this.addr,s),at(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Mo,s[o])}function fd(i,e,t){const n=this.cache,r=e.length,s=dr(t,r);st(n,s)||(i.uniform1iv(this.addr,s),at(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||To,s[o])}function pd(i,e,t){const n=this.cache,r=e.length,s=dr(t,r);st(n,s)||(i.uniform1iv(this.addr,s),at(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||wo,s[o])}function gd(i,e,t){const n=this.cache,r=e.length,s=dr(t,r);st(n,s)||(i.uniform1iv(this.addr,s),at(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||yo,s[o])}function md(i){switch(i){case 5126:return Zu;case 35664:return $u;case 35665:return ed;case 35666:return td;case 35674:return nd;case 35675:return id;case 35676:return rd;case 5124:case 35670:return sd;case 35667:case 35671:return ad;case 35668:case 35672:return od;case 35669:case 35673:return Ad;case 5125:return cd;case 36294:return ld;case 36295:return hd;case 36296:return ud;case 35678:case 36198:case 36298:case 36306:case 35682:return dd;case 35679:case 36299:case 36307:return fd;case 35680:case 36300:case 36308:case 36293:return pd;case 36289:case 36303:case 36311:case 36292:return gd}}class Ed{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=ju(t.type)}}class _d{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=md(t.type)}}class Cd{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Vr=/(\w+)(\])?(\[|\.)?/g;function La(i,e){i.seq.push(e),i.map[e.id]=e}function Id(i,e,t){const n=i.name,r=n.length;for(Vr.lastIndex=0;;){const s=Vr.exec(n),o=Vr.lastIndex;let a=s[1];const A=s[2]==="]",c=s[3];if(A&&(a=a|0),c===void 0||c==="["&&o+2===r){La(t,c===void 0?new Ed(a,i,e):new _d(a,i,e));break}else{let u=t.map[a];u===void 0&&(u=new Cd(a),La(t,u)),t=u}}}class $i{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Id(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],A=n[a.id];A.needsUpdate!==!1&&a.setValue(e,A.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Ua(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const xd=37297;let Sd=0;function vd(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Md(i){const e=Ye.getPrimaries(Ye.workingColorSpace),t=Ye.getPrimaries(i);let n;switch(e===t?n="":e===rr&&t===ir?n="LinearDisplayP3ToLinearSRGB":e===ir&&t===rr&&(n="LinearSRGBToLinearDisplayP3"),i){case zt:case Ii:return[n,"LinearTransferOETF"];case ct:case cr:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Qa(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+vd(i.getShaderSource(e),o)}else return r}function Bd(i,e){const t=Md(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function yd(i,e){let t;switch(e){case MA:t="Linear";break;case BA:t="Reinhard";break;case yA:t="OptimizedCineon";break;case TA:t="ACESFilmic";break;case RA:t="AgX";break;case wA:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Td(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ti).join(`
`)}function wd(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(ti).join(`
`)}function Rd(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function bd(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ti(i){return i!==""}function Pa(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Fa(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Dd=/^[ \t]*#include +<([\w\d./]+)>/gm;function fs(i){return i.replace(Dd,Ud)}const Ld=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Ud(i,e){let t=Pe[e];if(t===void 0){const n=Ld.get(e);if(n!==void 0)t=Pe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return fs(t)}const Qd=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Na(i){return i.replace(Qd,Pd)}function Pd(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Oa(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Fd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ja?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===$o?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jt&&(e="SHADOWMAP_TYPE_VSM"),e}function Nd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case yn:case si:e="ENVMAP_TYPE_CUBE";break;case Ar:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Od(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case si:e="ENVMAP_MODE_REFRACTION";break}return e}function Gd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Za:e="ENVMAP_BLENDING_MULTIPLY";break;case SA:e="ENVMAP_BLENDING_MIX";break;case vA:e="ENVMAP_BLENDING_ADD";break}return e}function Hd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function kd(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const A=Fd(t),c=Nd(t),l=Od(t),u=Gd(t),f=Hd(t),p=t.isWebGL2?"":Td(t),m=wd(t),g=Rd(s),d=r.createProgram();let h,S,C=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(h=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,g].filter(ti).join(`
`),h.length>0&&(h+=`
`),S=[p,"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,g].filter(ti).join(`
`),S.length>0&&(S+=`
